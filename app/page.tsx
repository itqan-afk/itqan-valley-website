...
const serviceCatalog = [
  {
    ...
    items: [
      ["سيرة ذاتية ATS", "صياغة احترافية متوافقة مع أنظمة الفرز."],
      ["تحسين ملف LinkedIn", "ملف متكامل يوضح قيمتك وخبراتك المهنية."],
      ["خطاب تقديم وظيفي", "خطاب مخصص يربط خبرتك بالفرصة المستهدفة."],
      ["سيرة ذاتية تنفيذية", "إبراز الأثر والقيادة وصناعة القرار."],
      ["تقييم السيرة الحالية", "مراجعة دقيقة مع توصيات قابلة للتطبيق."],
      ["باقة الحضور المهني", "سيرة باللغتين وLinkedIn وخطاب تقديم."],
    ],
  },
  {
    audience: "للأعمال",
    ...
    items: [
      ["إدارة الأداء التنفيذي", "مؤشرات ونتائج وإجراءات في دورة واحدة."],
      ["لوحة مؤشرات مخصصة", "قياس يناسب الإدارة وأولويات المنشأة."],
      ["نظام الاجتماعات والقرارات", "متابعة القرار حتى التنفيذ والإغلاق."],
      ["تصميم تقرير تنفيذي", "تحويل البيانات إلى عرض مختصر للقرار."],
      ["توثيق الإجراءات ومسارات العمل", "أدوار واعتمادات ومخرجات واضحة."],
    ],
  },
];
